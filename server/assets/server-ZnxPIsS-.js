...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DwIuETze.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-cxZrluTg.js"),
    import("./start-BefrEI5W.js"),
...
var ROUTER_BASEPATH = "supa-tasks";
var SERVER_FN_BASE = "/supa-tasks/_serverFn/";
